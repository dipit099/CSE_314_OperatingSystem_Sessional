...
void *student_activities(void *arg) {
  ...
  usleep(student->writing_time * SLEEP_MULTIPLIER); 
...
//   But it could take a long time if:

// The random number generator keeps hitting already-started students.
